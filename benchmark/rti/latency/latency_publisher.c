...
static int publisher_main(int domainId, int sample_count)
{
    ...
    instance = latencyTypeSupport_create_data_ex(DDS_BOOLEAN_TRUE);
...
*/
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        retcode = latencyDataWriter_write(
            latency_writer, instance, &instance_handle);
        if (retcode != DDS_RETCODE_OK) {
...
*/
    ...
    /* Delete data sample */
    retcode = latencyTypeSupport_delete_data_ex(instance, DDS_BOOLEAN_TRUE);
    if (retcode != DDS_RETCODE_OK) {
