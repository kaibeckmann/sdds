...
/**
   ...
   Configure and implement 'latencyEcho' support classes.
...
/* Requires */
#define TTYPENAME   latencyEchoTYPENAME

/* Defines */
#define TDataWriter latencyEchoDataWriter
#define TData       latencyEcho
...
/* Defines */
#define TDataReader latencyEchoDataReader
#define TDataSeq    latencyEchoSeq
#define TData       latencyEcho
...
/* Requires */
#define TTYPENAME    latencyEchoTYPENAME
#define TPlugin_new  latencyEchoPlugin_new
#define TPlugin_delete  latencyEchoPlugin_delete

/* Defines */
#define TTypeSupport latencyEchoTypeSupport
#define TData        latencyEcho
#define TDataReader  latencyEchoDataReader
#define TDataWriter  latencyEchoDataWriter
#ifdef __cplusplus
