...
{
    uint64_t rtt = (uint64_t) timex_uint64(timex_sub(current_time, tcp_control->last_packet_time));
    uint64_t srtt = tcp_control->srtt;
    uint64_t rttvar = tcp_control->rttvar;
    uint64_t rto = tcp_control->rto;
