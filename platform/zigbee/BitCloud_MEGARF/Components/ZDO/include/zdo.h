...
#define ZDP_NEIGBOR_TABLE_LIST_OFFSET 3
...
/**************************************************************************//**
\brief Check if supplied address is an address of  TC

This function check if supplied address is an address of TC

\param[in] addr - Address to check
\return true - if this is a TC address, false - otherwise
******************************************************************************/
bool ZDO_IsTcAddress(ExtAddr_t *addr);
