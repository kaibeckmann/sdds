...
#define ZCL_DEFINE_BASIC_CLUSTER_SERVER_ATTRIBUTES()                                                            \
  DEFINE_ATTRIBUTE(zclVersion,  ZCL_BASIC_CLUSTER_SERVER_ZCL_VERSION_ATTRIBUTE_ID,  ZCL_U8BIT_DATA_TYPE_ID),    \
  DEFINE_ATTRIBUTE(powerSource, ZCL_BASIC_CLUSTER_SERVER_POWER_SOURCE_ATTRIBUTE_ID, ZCL_8BIT_ENUM_DATA_TYPE_ID)
...
*******************************************************************************/
#define ZCL_DEFINE_BASIC_CLUSTER_SERVER(attributes)                           \
  {                                                                           \
    .id = BASIC_CLUSTER_ID,                                                   \
...
#if 0
// The RestToFactoryDefaults command is optional now.
/***************************************************************************//**
  \brief
