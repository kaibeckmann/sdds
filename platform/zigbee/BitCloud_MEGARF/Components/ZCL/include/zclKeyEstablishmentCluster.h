...
/***************************************************************************//**
  \brief ZCL Key Establishment Cluster server side commands amount
*******************************************************************************/
#define ZCL_KE_CLUSTER_SERVER_COMMANDS_AMOUNT          4
...
/***************************************************************************//**
  \brief ZCL Key Establishment Cluster derver side commands amount
*******************************************************************************/
#define ZCL_KE_CLUSTER_CLIENT_COMMANDS_AMOUNT          4
//There are no any commands at the client side

//Atribute Ids of Information Attribute Set at the server side
//!Key Establishment Suite Attribute
#define ZCL_KE_CLUSTER_SERVER_KEY_ESTABLISHMENT_SUITE_ATTRIBUTE_ID    CCPU_TO_LE16(0x0000)

//Atribute Ids of Information Attribute Set at the client side
//!Key Establishment Suite Attribute
...
#define ZCL_DEFINE_EK_CLUSTER_SERVER_ATTRIBUTES()   \
  {DEFINE_ATTRIBUTE(keyEstablishmentSuite,  ZCL_KE_CLUSTER_SERVER_KEY_ESTABLISHMENT_SUITE_ATTRIBUTE_ID,  ZCL_16BIT_ENUM_DATA_TYPE_ID)}
...
#define ZCL_DEFINE_EK_CLUSTER_CLIENT_ATTRIBUTES()   \
  {DEFINE_ATTRIBUTE(keyEstablishmentSuite,  ZCL_KE_CLUSTER_CLIENT_KEY_ESTABLISHMENT_SUITE_ATTRIBUTE_ID,  ZCL_16BIT_ENUM_DATA_TYPE_ID)}


#define ZCL_DEFINE_EK_CLUSTER_SERVER_COMMANDS(initiateKERequestHandler,       \
                                              ephemeralDataRequestHandler,    \
                                              confirmDataRequestHandler,      \
                                              terminateKEHandler)             \
  {DEFINE_COMMAND(initiateKeyEstablishmentCommand,  ZCL_KE_INITIATE_KEY_ESTABLISHMENT_REQUEST_COMMAND_ID, COMMAND_OPTIONS(CLIENT_TO_SERVER, ZCL_THERE_IS_RELEVANT_RESPONSE), initiateKERequestHandler),   \
   DEFINE_COMMAND(ephemeralDataRequestCommand,      ZCL_KE_EPHEMERAL_DATA_REQUEST_COMMAND_ID,             COMMAND_OPTIONS(CLIENT_TO_SERVER, ZCL_THERE_IS_RELEVANT_RESPONSE), ephemeralDataRequestHandler),\
   DEFINE_COMMAND(confirmKeyDataRequestCommand,     ZCL_KE_CONFIRM_KEY_DATA_REQUEST_COMMAND_ID,           COMMAND_OPTIONS(CLIENT_TO_SERVER, ZCL_THERE_IS_RELEVANT_RESPONSE), confirmDataRequestHandler),  \
   DEFINE_COMMAND(terminateKeyEstablishmentCommand, ZCL_KE_TERMINATE_KEY_ESTABLISHMENT_COMMAND_ID,        COMMAND_OPTIONS(CLIENT_TO_SERVER, ZCL_THERE_IS_NO_RELEVANT_RESPONSE), terminateKEHandler)}



#define ZCL_DEFINE_EK_CLUSTER_CLIENT_COMMANDS(initiateKEResponseHandler,      \
                                              ephemeralDataResponseHandler,   \
                                              confirmDataResponseHandler,     \
                                              terminateKEHandler)             \
  {DEFINE_COMMAND(initiateKeyEstablishmentCommand,  ZCL_KE_INITIATE_KEY_ESTABLISHMENT_RESPONSE_COMMAND_ID,  COMMAND_OPTIONS(SERVER_TO_CLIENT, ZCL_THERE_IS_NO_RELEVANT_RESPONSE), initiateKEResponseHandler),   \
   DEFINE_COMMAND(ephemeralDataResponseCommand,     ZCL_KE_EPHEMERAL_DATA_RESPONSE_COMMAND_ID,              COMMAND_OPTIONS(SERVER_TO_CLIENT, ZCL_THERE_IS_NO_RELEVANT_RESPONSE), ephemeralDataResponseHandler),\
   DEFINE_COMMAND(confirmKeyDataResponseCommand,    ZCL_KE_CONFIRM_KEY_DATA_RESPONSE_COMMAND_ID,            COMMAND_OPTIONS(SERVER_TO_CLIENT, ZCL_THERE_IS_NO_RELEVANT_RESPONSE), confirmDataResponseHandler),  \
   DEFINE_COMMAND(terminateKeyEstablishmentCommand, ZCL_KE_TERMINATE_KEY_ESTABLISHMENT_COMMAND_ID,          COMMAND_OPTIONS(SERVER_TO_CLIENT, ZCL_THERE_IS_NO_RELEVANT_RESPONSE), terminateKEHandler)}
...
#define ZCL_DEFINE_KE_CLUSTER_SERVER(clattributes, clcommands)                \
  {                                                                           \
    ...
    .commandsAmount = ZCL_KE_CLUSTER_SERVER_COMMANDS_AMOUNT,                  \
...
/***************************************************************************//**
  \brief
    ZCL Key Establishment Cluster Server Commands should be received
*******************************************************************************/
typedef struct
{
  ...
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x00, #ZCL_KE_INITIATE_KEY_ESTABLISHMENT_REQUEST_COMMAND_ID)
  ...
  } initiateKeyEstablishmentCommand;

  //!Ephemeral Data Request Command descriptor
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x01, #ZCL_KE_EPHEMERAL_DATA_REQUEST_COMMAND_ID)
    ZclCommandOptions_t   options;  //!<Command options
    /**
      \brief Command indication handler
  ...
  } ephemeralDataRequestCommand;

  //!Confirm Key Data Request Command descriptor
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x02, #ZCL_KE_CONFIRM_KEY_DATA_REQUEST_COMMAND_ID)
    ZclCommandOptions_t   options;  //!<Command options
    /**
      \brief Command indication handler
      \param payloadLength - length of payload in cotets
  ...
  } confirmKeyDataRequestCommand;

  //!Terminate Key Establishment Command descriptor
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x03, #ZCL_KE_TERMINATE_KEY_ESTABLISHMENT_COMMAND_ID)
    ZclCommandOptions_t   options;  //!<Command options
    /**
      \brief Command indication handler
      \param payloadLength - length of payload in cotets
  ...
  } terminateKeyEstablishmentCommand;
} ZCL_KEClusterServerCommands_t;

/***************************************************************************//**
  \brief
    ZCL Key Establishment Cluster Client Commands should be received
*******************************************************************************/
typedef struct
{
  ...
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x00, #ZCL_KE_INITIATE_KEY_ESTABLISHMENT_RESPONSE_COMMAND_ID)
    ZclCommandOptions_t   options;  //!<Command options
    /**
      \brief Command indication handler
      \param payloadLength - length of payload in octets
  ...
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x01, #ZCL_KE_EPHEMERAL_DATA_RESPONSE_COMMAND_ID)
    ZclCommandOptions_t   options;  //!<Command options
    /**
      \brief Command indication handler
      \param payloadLength - length of payload in cotets
    ...
    */
    ZCL_Status_t (*indHandler)(ZCL_Addressing_t *addressing, uint8_t payloadLength, ZCL_EphemeralDataCommand_t *payload);
  } ephemeralDataResponseCommand;

  //!Confirm Key Data Response Command descriptor
  struct
  {
    ZCL_CommandId_t       id;       //!<Command Id (0x02, #ZCL_KE_CONFIRM_KEY_DATA_RESPONSE_COMMAND_ID)
    ZclCommandOptions_t   options;  //!<Command options
    /**
      \brief Command indication handler
      \param payloadLength - length of payload in cotets
