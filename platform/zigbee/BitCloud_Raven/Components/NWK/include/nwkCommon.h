/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nwkCommon.h 12575 2010-09-25 21:25:48Z mgekk $
 ******************************************************************************/
...
/** Length of auxiliary frame header. See ZigBee spec r18, Figure 4.3. */
  ...
  #define NWK_SECURITY_HEADER_SIZE    14U
  #define NWK_MAX_DATA_FRAME_FOOTER_LENGTH  16U
#else
  #define NWK_SECURITY_HEADER_SIZE    0U
  #define NWK_MAX_DATA_FRAME_FOOTER_LENGTH  1U
#endif /* _SECURITY_ */
...
#define NWK_MAX_DATA_FRAME_HEADER_LEHGTH \
  (NWK_DATA_FRAME_HEADER_LENGTH + NWK_MAX_SOURCE_ROUTE_SUBFRAME_LENGTH \
   + NWK_SECURITY_HEADER_SIZE)

/** Length of the reserved part in the data frame. */
#define NWK_AFFIX_LENGTH \
...
#define NWK_MAX_NSDU_SIZE \
  (MAC_MAX_MSDU_SIZE - NWK_MAX_DATA_FRAME_HEADER_LEHGTH \
   - NWK_MAX_DATA_FRAME_FOOTER_LENGTH)
...
#define NWKC_MAX_BROADCAST_JITTER_MASK  (0x40U-1U)
