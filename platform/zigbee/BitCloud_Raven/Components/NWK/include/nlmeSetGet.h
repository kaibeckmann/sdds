/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nlmeSetGet.h 12575 2010-09-25 21:25:48Z mgekk $
 ******************************************************************************/
...
typedef enum _NWK_NibId_t
{
   ...
   * set to 0. If this attribute has a value of 0x01, the NWK layer shall not relay
   * frames that have the security sub-field of the frame control field set to 0.
   * The SecurityEnable parameter of the NLDE-DATA.request primitive shall override
