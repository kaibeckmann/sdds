/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nwkNeighborTable.h 12570 2010-09-24 20:25:34Z mgekk $
 ******************************************************************************/
...
/**************************************************************************//**
  ...
  \param[in] powerFailure - restore the neighbor table from configServer or not.
  \return None.
 ******************************************************************************/
NWK_PRIVATE void nwkResetNeighborTable(bool powerFailure);
...
/**************************************************************************//**
  ...
  \return None.
 ******************************************************************************/
NWK_PRIVATE void nwkUpdateCapacityBits(NwkChildCount_t endDeviceCount,
  NwkChildCount_t routerCount);
