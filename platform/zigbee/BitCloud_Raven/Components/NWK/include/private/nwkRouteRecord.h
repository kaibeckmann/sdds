/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nwkRouteRecord.h 12570 2010-09-24 20:25:34Z mgekk $
 ******************************************************************************/
/**
 *  The route record command allows the route taken by a unicast packet through
 * the network to be recorded in the command payload and delivered to
 * the destination device. ZigBee spec r18, 3.4.5, page 330.
 **/
...
#define  NWK_ROUTE_RECORD_TX_PARAMETERS \
  {NWK_TX_DELAY_UNICAST_COMMAND, nwkPrepareRouteRecordTx, \
