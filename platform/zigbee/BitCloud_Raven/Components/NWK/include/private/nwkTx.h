/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nwkTx.h 12570 2010-09-24 20:25:34Z mgekk $
 ******************************************************************************/
...
typedef void  (* NwkConfirmTxFunc_t)(NwkOutputPacket_t  *const, NWK_Status_t);
...
/**************************************************************************//**
  ...
  \return None.
 ******************************************************************************/
NWK_PRIVATE void nwkTxConf(NwkOutputPacket_t  *const outPkt, NWK_Status_t status);
