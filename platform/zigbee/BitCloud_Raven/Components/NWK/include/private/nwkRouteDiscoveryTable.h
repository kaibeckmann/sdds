/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nwkRouteDiscoveryTable.h 12570 2010-09-24 20:25:34Z mgekk $
 ******************************************************************************/
/**
...
typedef struct _NwkRouteDiscoveryEntry_t
{
   ...
   * lowest cost route request command frame corresponding to this entry's route
   * request identifier and source address. This field is used to determine
...
/**************************************************************************//**
  ...
  \return None.
 ******************************************************************************/
NWK_PRIVATE void nwkSendRouteDiscoveryRequest(
