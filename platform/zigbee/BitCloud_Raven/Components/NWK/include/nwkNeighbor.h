/**************************************************************************//**
 ...
 \author
  ...
  \internal
   ...
   Last change:
    $Id: nwkNeighbor.h 12575 2010-09-25 21:25:48Z mgekk $
 ******************************************************************************/
...
typedef struct _NwkNeighbor_t
{
  ...
  /** Upper layer knowns about this neighbor (true) or not (false).*/
  bool  indicated          :1;
...
/**************************************************************************//**
  ...
  \param[in] neighbor - pointer to the child in the neighbor table.
  \return None.
 ******************************************************************************/
