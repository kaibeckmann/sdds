...
#define APP_TMR_TCCRnB             TCCR1B
#define APP_TMR_OCRnA              OCR1A
#define APP_TMR_TIMSKn             TIMSK1
#define APP_TMR_TCNTn              TCNT1
#define APP_TMR_TIMERn_COMPA_vect  TIMER1_COMPA_vect
#define APP_TMR_OCIEnA             OCIE1A
...
{
  APP_TMR_TCCRnB |= HAL_CLOCK_SELECTION_MASK;
}
...
{
  APP_TMR_TCCRnB &= ~HAL_CLOCK_SELECTION_MASK; // stop the timer
}
