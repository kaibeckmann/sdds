...
#define MAXIMUM_POWER_COSUPTION 0x32  // Step is 2 mA.
...
const ConfigurationFrameResponse_t vcpConfigDescriptor = {
  { // configuration
    ...
    MAXIMUM_POWER_COSUPTION             // Maximum power consumption of the device when in this configuration
  },
  { // interface 1
