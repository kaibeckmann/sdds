...
#define lcd_symbol_battery_set(nmb)     lcd_symbol_battery_empty(); lcd_symbol_set_group(LCD_SYMBOL_INDEX_BAT_CONT, nmb-LCD_SYMBOL_INDEX_BAT_CONT+1)
...
#define lcd_symbol_antenna_signal(nmb)  lcd_symbol_antenna_clr_sig(); lcd_symbol_set_group(LCD_SYMBOL_INDEX_ANT_FOOT, nmb-LCD_SYMBOL_INDEX_ANT_FOOT+1)
#define lcd_symbol_antenna_disable()    lcd_symbol_clr_group(LCD_SYMBOL_INDEX_ANT_FOOT, LCD_SYMBOL_INDEX_ANT_DIS - LCD_SYMBOL_INDEX_ANT_FOOT + 1)
...
typedef enum {
    ...
    // Antenna status
    LCD_SYMBOL_INDEX_ANT_FOOT, // 0x11
    LCD_SYMBOL_INDEX_ANT_SIG1, // 0x12
    LCD_SYMBOL_INDEX_ANT_SIG2, // 0x13
    LCD_SYMBOL_INDEX_ANT_SIG3, // 0x14
    LCD_SYMBOL_INDEX_ANT_DIS,  // 0x15

    // Battery status
    LCD_SYMBOL_INDEX_BAT_CONT, // 0x16
    LCD_SYMBOL_INDEX_BAT_CAP1, // 0x17
    LCD_SYMBOL_INDEX_BAT_CAP2, // 0x18
    LCD_SYMBOL_INDEX_BAT_CAP3, // 0x19
