...
C_CXX_FLAGS     += -Wall -Wl,-EL -nostdlib -mlongcalls -mtext-section-literals $(CPPFLAGS)
# Flags for C only
...
$(PROGRAM_OUT): $(COMPONENT_ARS) $(SDDS_OBJS) $(SDK_PROCESSED_LIBS) $(LINKER_SCRIPTS_PROCESSED)
	$(vecho) "LD $@"
	$(Q) $(LD) $(LDFLAGS) -Wl,--start-group -objs-esp.a $(COMPONENT_ARS) $(LIB_ARGS) $(SDK_LIB_ARGS) $(SDDS_OBJS) -Wl,--end-group -o $@
