...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/test_unit_history_reliable_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/test_unit_history_reliable.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/test_unit_history_reliable.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
