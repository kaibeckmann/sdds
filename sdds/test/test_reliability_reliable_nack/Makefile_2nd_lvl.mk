...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/test_reliability_reliable_nack_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/test_reliability_reliable_nack.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/test_reliability_reliable_nack.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
