...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/test_echo_linux_reliability_reliable_ack_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/test_echo_linux_reliability_reliable_ack.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/test_echo_linux_reliability_reliable_ack.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
