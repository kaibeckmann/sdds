...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/test_qos_reliability_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/test_qos_reliability.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/test_qos_reliability.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
