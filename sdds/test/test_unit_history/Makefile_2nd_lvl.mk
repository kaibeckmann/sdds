...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/test_unit_history_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/test_unit_history.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/test_unit_history.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
