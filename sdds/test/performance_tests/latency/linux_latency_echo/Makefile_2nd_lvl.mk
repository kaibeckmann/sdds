...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/linux_latency_echo_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/linux_latency_echo.o

SDDS_CONSTANTS_FILE := ./gen_constants.h

include $(SDDS_TOPDIR)/sdds.mk

DATA_DEPEND_OBJS += $(SDDS_OBJDIR)/latency-ds.o
DATA_DEPEND_OBJS += $(SDDS_OBJDIR)/latencyecho-ds.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/linux_latency_echo.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
