...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/linux_latency_host_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/linux_latency_host.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/linux_latency_host.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
