...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/linux_scalability_sub_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/linux_scalability_sub.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/linux_scalability_sub.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
