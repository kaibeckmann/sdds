...
IMPL_DEPEND_OBJS = $(SDDS_OBJDIR)/test_unit_reliability_reliable_sdds_impl.o
ALL_OBJS += $(IMPL_DEPEND_OBJS)
ALL_OBJS += $(SDDS_OBJDIR)/test_unit_reliability_reliable.o
...
$(APPLICATION_NAME): $(SDDS_OBJDIR)/test_unit_reliability_reliable.o $(SDDS_OBJS) $(IMPL_DEPEND_OBJS) $(DATA_DEPEND_OBJS)
	$(CC) -o $@ $^ $(LDLIBS)
