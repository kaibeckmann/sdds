...
#define TWI_SDA_DDR INTERNAL_CONCAT(DDR, DRIVER_TWI_DATA_PORT)
#define TWI_SDA_DD INTERNAL_CONCAT(DD, INTERNAL_CONCAT(DRIVER_TWI_DATA_PORT, DRIVER_TWI_DATA_PIN))
#define TWI_SDA_PORTR INTERNAL_CONCAT(PORT, DRIVER_TWI_DATA_PORT)
#define TWI_SDA_PORT INTERNAL_CONCAT(P, INTERNAL_CONCAT(DRIVER_TWI_DATA_PORT, DRIVER_TWI_DATA_PIN))
#define TWI_SCL_PINR INTERNAL_CONCAT(PIN, DRIVER_TWI_CLOCK_PORT)
#define TWI_SCL_PIN INTERNAL_CONCAT(TWI_SCL_PINR, DRIVER_TWI_CLOCK_PIN)
#define TWI_SCL_DDR INTERNAL_CONCAT(DDR, DRIVER_TWI_CLOCK_PORT)
#define TWI_SCL_DD INTERNAL_CONCAT(DD, INTERNAL_CONCAT(DRIVER_TWI_CLOCK_PORT, DRIVER_TWI_CLOCK_PIN))
#define TWI_SCL_PORTR INTERNAL_CONCAT(PORT, DRIVER_TWI_CLOCK_PORT)
#define TWI_SCL_PORT INTERNAL_CONCAT(P, INTERNAL_CONCAT(DRIVER_TWI_CLOCK_PORT, DRIVER_TWI_CLOCK_PIN))
...
#error "Please set F_CPU to the frequency of the target system in Hz."
	...
	TWSR = 0;
	TWBR = (uint8_t)(F_CPU / DRIVER_TWI_BUS_SPEED - 16) / 2;
	TWDR = 0xFF;
	TWCR = _BV(TWEN);
